...
fn main() {
    ...
    const LAGGING_CONSTANT: u32 = 4096;
    const NUM_CALCS: u32 = 5;

    let init_c: u32 = 809430660;
    let cmwc: bool = false;
    let bit_size: u32;
    let a: u32 = 18782;
    ...
    //target_pointer_width determines operating system size
    #[cfg(target_pointer_width = "32")]
    {
        ...
        let rand_x: u32; 
        init_x = random();
        println!("\nThe randomly generated seed for the generator is {} \n", init_x);
        ...
        if cmwc {
            ...
            output_list = mwc_calc_32_bit(init_x,a, base_val, init_c, LAGGING_CONSTANT, NUM_CALCS);
        }
    }
